...
public class BST {
	...
	public void addLeftSubTreeToMin(BST subtree) {
		...
		TreeIterator n = (TreeIterator)findMin();
		BSTNode newNodeMax = ((TreeIterator)(subtree.findMax())).currentNode;
		if(root==null) {
			root = subtree.root;
			size += subtree.size;
			return;
		}
		if(newNodeMax.data>n.currentNode.data)return;
		
		n.currentNode.left = subtree.root;
		subtree.root.parent = n.currentNode.left;
